...
class ObSysVarObBmwTopkReserveRatio : public ObIntSysVar
{
public:
  ObSysVarObBmwTopkReserveRatio() : ObIntSysVar(NULL, NULL, NULL, NULL, NULL) {}
  inline virtual ObSysVarClassType get_type() const { return SYS_VAR_OB_BMW_TOPK_RESERVE_RATIO; }
